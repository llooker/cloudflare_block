- dashboard: performance_cloudflare
  ...
  - title: Uncached Requests
    ...
    fields:
    - cloudflare_logs.count
    - cloudflare_logs.is_not_cached_r
    filters:
  ...
  - title: Total number of requests vs cached vs uncached over time
    ...
    - label: Requests
      orientation: left
      series:
      - id: cloudflare_logs.count
        name: Total requests
        axisId: cloudflare_logs.count
      - id: cloudflare_logs.cached_count
        name: Cached requests
        axisId: cloudflare_logs.cached_count
      - id: cloudflare_logs.uncached_count
        name: Uncached requests
        axisId: cloudflare_logs.uncached_count
      showLabels: true
      showValues: true
      unpinAxis: false
      tickDensity: default
  ...
  - title: Total Requests vs. Origin Requests in rps last 24 hours
    ...
    - label: rps
      orientation: left
      series:
      - id: cloudflare_logs.avg_rps_15m
        name: Camiliame Logs total rps
        axisId: cloudflare_logs.avg_rps_15m
      showLabels: true
      showValues: true
      unpinAxis: false
      tickDensity: default
  ...
  - title: Total Bandwidth vs Origin Bandwidth in Mbps last 24 hours
    ...
    fields:
    - cloudflare_logs.edge_start_timestamp_minute15
    - cloudflare_logs.average_origin_bandwidth
  ...
  - title: Cached vs Uncached Bandwidth Over Time
    ...
    - label: ''
      orientation: left
      series:
      - id: cloudflare_logs.saved_bandwidth
        name: Saved Bandwidth
        axisId: cloudflare_logs.saved_bandwidth
      - id: cloudflare_logs.uncached_bandwidth
        name: Uncached Bandwidth
        axisId: cloudflare_logs.uncached_bandwidth
      showLabels: true
      showValues: true
  ...
  - title: Top URIs with Cache Status Miss
    ...
    - cloudflare_logs.cache_cache_status
    pivots:
    - cloudflare_logs.cache_cache_status
    filters:
      cloudflare_logs.cache_cache_status: miss
    sorts:
    - cloudflare_logs.count desc 0
    - cloudflare_logs.cache_cache_status
    limit: 500
    query_timezone: America/Los_Angeles
    show_view_names: false
  ...
  - title: Origin time to first byte dynamic requests
    ...
    type: looker_line
    fields:
    - cloudflare_logs.percentile95_originresponsetime
    - cloudflare_logs.percentile75_originresponsetime
    - cloudflare_logs.percentile50_originresponsetime
    - cloudflare_logs.edge_start_timestamp_hour
    fill_fields:
    - cloudflare_logs.edge_start_timestamp_hour
    filters:
  ...
  - title: Slowest URIs by cumulative time to first byte for dynamic requests
    ...
    - events_per_second.avg_events_per_second
    - cloudflare_logs.count
    - cloudflare_logs.avg_originresponsetime
    - cloudflare_logs.waittime_originresponsetime
    - cloudflare_logs.percentile99_originresponsetime
    - cloudflare_logs.percentile999_originresponsetime
    filters:
      cloudflare_logs.is_dynamic: 'Yes'
    sorts:
    - cloudflare_logs.waittime_originresponsetime desc
    limit: 500
    column_limit: 50
    show_view_names: false
    show_row_numbers: true
  ...
  - title: Origin requests by hostname in rps
    ...
    type: table
    fields:
    - cloudflare_logs.client_request_host
    - events_per_second.avg_events_per_second
