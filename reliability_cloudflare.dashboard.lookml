- dashboard: reliability_cloudflare
  ...
  - title: 4xx Errors (Edge)
    ...
    - cloudflare_logs.edge_start_timestamp_week
    fill_fields:
    - cloudflare_logs.edge_start_timestamp_week
    filters:
      cloudflare_logs.edge_response_status_class_4xx: "-NULL"
    sorts:
    - cloudflare_logs.edge_start_timestamp_week desc
    limit: 500
    column_limit: 50
    dynamic_fields:
  ...
  - title: Edge Response Error Ratio
    ...
    fields:
    - cloudflare_logs.count
    - cloudflare_logs.edge_response_status_class
    sorts:
  ...
  - title: Origin Response Status Over Time
    ...
    - cloudflare_logs.count
    - cloudflare_logs.edge_start_timestamp_hour
    - cloudflare_logs.origin_response_status
    pivots:
    - cloudflare_logs.origin_response_status
    fill_fields:
    - cloudflare_logs.edge_start_timestamp_hour
  ...
  - title: Origin Response Error Ratio
    ...
    fields:
    - cloudflare_logs.count
    - cloudflare_logs.origin_response_status_class
    sorts:
    - cloudflare_logs.count desc
    limit: 500
    query_timezone: America/Los_Angeles
  ...
  - title: Edge Response Status in rps
    ...
    height: 5
  - title: Edge Response Status in rps
    name: Edge Response Status in rps text
    model: cloudflare_looker
    explore: cloudflare_logs
    type: looker_line
    fields:
