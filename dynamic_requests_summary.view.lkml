view: dynamic_requests_summary {
  derived_table: {
    sql: -- raw sql results do not include filled-in values for 'camiliame_logs.edge_start_timestamp_minute15'
      ...
      WHERE camiliame_logs.CacheCacheStatus IN ("bypass", "unknown")
      UNION ALL
